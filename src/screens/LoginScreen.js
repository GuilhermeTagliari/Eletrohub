...
function makeStyles(colors) {
  return StyleSheet.create({
    ...
    logoBox: { alignItems: 'center', justifyContent: 'center', marginVertical: 28, paddingVertical: 8 },
    logoName: { fontSize: 44, fontWeight: '300', color: colors.text, letterSpacing: -1 },
    logoBold: { fontWeight: '900' },
    logoSub: { fontSize: 11, color: colors.textMuted, letterSpacing: 2, textTransform: 'uppercase', marginTop: 4 },
    headline: { fontSize: 18, fontWeight: '700', color: colors.text, textAlign: 'center', marginBottom: 6 },
    subtext: { fontSize: 13, color: colors.textSecondary, textAlign: 'center', lineHeight: 20, marginBottom: 28 },
    ...
    dividerRow: {
      flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 28, marginBottom: 18,
    },
    ...
    switchText: { textAlign: 'center', fontSize: 14, color: colors.textSecondary, marginTop: 20 },
